...
Name: Sukanya Tool Used: CVE Details + CIRCL Lookup (Mobile-based Vulnerability Scanning - Alternative to Nessus/OpenVAS) Target: Google Chrome (Version < 151.0.7922.72) - My Device Date: 01-09-2026
...
Total Vulnerabilities Found for Chrome: 200+ Filtered by CVSS Min 7 (High/Critical): 4 Critical Vulnerabilities found in recent scan.
...
Updated Google Chrome to latest version (Settings > About Chrome)
Enabled Enhanced Protection in Chrome Safety
